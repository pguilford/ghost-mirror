...
var timeout,html=$("html"),body=$("body"),st=0,lastSt=0,titleOffset=0,contentOffset=0,progress=$(".sticky-progress");function sticky(){"use strict";st=jQuery(window).scrollTop(),0<titleOffset&&0<contentOffset&&(lastSt<st?titleOffset<st&&body.addClass("sticky-visible"):st<=titleOffset&&body.removeClass("sticky-visible")),progress.css("transform","translate3d("+(-100+Math.min(100*st/contentOffset,100))+"%,0,0)"),lastSt=st}function subMenu(){"use strict";var t=$(".main-nav"),e=t.find('.menu-item[href*="..."]');if(e.length){e.nextAll(".menu-item").wrapAll('<div class="sub-menu" />'),e.replaceWith('<button class="button-icon menu-item-button menu-item-more" aria-label="More"><svg class="icon"><use xlink:href="#dots-horizontal"></use></svg></button>');var a=t.find(".menu-item-more"),n=$(".sub-menu");a.append(n),a.on("click",function(){n.is(":visible")?n.addClass("animate__animated animate__zoomOut"):n.show().addClass("animate__animated animate__bounceIn")}),n.on("animationend",function(t){n.removeClass("animate__animated animate__bounceIn animate__zoomOut"),"zoomOut"==t.originalEvent.animationName&&n.hide()})}}function whiteLogo(){"use strict";if(""!=themeOptions.white_logo){var t='<img class="logo-image white" src="'+themeOptions.white_logo+'">';$(".logo").prepend(t)}}function whiteIcon(){"use strict";if(void 0!==themeOptions.white_icon&&""!=themeOptions.white_icon){var t='<img class="cover-icon-image white" src="'+themeOptions.white_icon+'">';$(".cover-icon").prepend(t)}}function featured(){"use strict";$(".featured-feed").owlCarousel({dots:!1,margin:30,nav:!0,navText:['<svg class="icon"><use xlink:href="#chevron-left"></use></svg>','<svg class="icon"><use xlink:href="#chevron-right"></use></svg>'],responsive:{0:{items:1},768:{items:2},992:{items:3}}})}function pagination(){"use strict";var t=$(".post-feed");body.hasClass("paged-next")&&t.infiniteScroll({append:".feed",button:".infinite-scroll-button",debug:!1,hideNav:".pagination",path:".pagination .older-posts",scrollThreshold:!1,status:".infinite-scroll-status"}),t.on("append.infiniteScroll",function(t,e,a,n){$(n[0]).addClass("feed-paged")})}function video(){"use strict";$(".single-content").fitVids()}function gallery(){"use strict";document.querySelectorAll(".kg-gallery-image img").forEach(function(t){var e=t.closest(".kg-gallery-image"),a=t.attributes.width.value/t.attributes.height.value;e.style.flex=a+" 1 0%"}),pswp(".kg-gallery-container",".kg-gallery-image",".kg-gallery-image",!1,!0)}function table(){"use strict";(body.hasClass("post-template")||body.hasClass("page-template"))&&$(".single-content").find(".table").each(function(t,e){var a=[];$(e).find("thead th").each(function(t,e){a.push($(e).text())}),$(e).find("tr").each(function(t,e){$(e).find("td").each(function(t,e){$(e).attr("data-label",a[t])})})})}function toc(){"use strict";if(body.hasClass("post-template")){var n="",t=$(".sticky-toc-button");$(".single-content").find("> h2, > h3").each(function(t,e){var a="H3"==$(this).prop("tagName")?"sticky-toc-link sticky-toc-link-indented":"sticky-toc-link";n+='<a class="'+a+'" href="#'+$(e).attr("id")+'">'+$(e).text()+"</a>"}),""==n&&t.remove(),$(".sticky-toc").html(n),t.on("click",function(){body.toggleClass("toc-opened")}),$(".sticky-toc-link").on("click",function(t){t.preventDefault();var e=$(this).attr("href");$("html, body").animate({scrollTop:$(e).offset().top-82},500)})}}function modal(){"use strict";var e=$(".modal-overlay"),t=$(".modal"),a=$(".modal-input");$(".js-modal").on("click",function(t){t.preventDefault(),e.show().outerWidth(),body.addClass("modal-opened"),a.focus()}),$(".modal-close, .modal-overlay").on("click",function(){body.removeClass("modal-opened")}),t.on("click",function(t){t.stopPropagation()}),$(document).keyup(function(t){27===t.keyCode&&body.hasClass("modal-opened")&&body.removeClass("modal-opened")}),e.on("transitionend",function(t){body.hasClass("modal-opened")||e.hide()}),t.on("transitionend",function(t){t.stopPropagation()})}function search(){"use strict";if(""!=themeOptions.search_key){var n,t=$(".search-input"),o=$(".search-button"),i=$(".search-result"),s=$(".popular-wrapper"),e=siteUrl+"/ghost/api/v2/content/posts/?key="+themeOptions.search_key+"&limit=all&fields=id,title,url,updated_at,visibility&order=updated_at%20desc&formats=plaintext",a=JSON.parse(localStorage.getItem("dawn_search_index"));elasticlunr.clearStopWords(),localStorage.removeItem("dawn_index"),localStorage.removeItem("dawn_last"),a&&themeOptions.search_migration==localStorage.getItem("dawn_search_migration")?(n=elasticlunr.Index.load(a),$.get(e+"&filter=updated_at:>'"+localStorage.getItem("dawn_search_last").replace(/\..*/,"").replace(/T/," ")+"'",function(t){0<t.posts.length&&l(t)})):$.get(e,function(t){0<t.posts.length&&(n=elasticlunr(function(){this.addField("title"),this.addField("plaintext"),this.setRef("id")}),l(t),void 0!==themeOptions.search_migration&&localStorage.setItem("dawn_search_migration",themeOptions.search_migration))}),t.on("keyup",function(t){var e=n.search(t.target.value,{expand:!0}),a="";e.forEach(function(t){a+='<div class="search-result-row"><a class="search-result-row-link" href="'+t.doc.url+'">'+t.doc.title+"</a></div>"}),i.html(a),0<t.target.value.length?o.addClass("search-button-clear"):o.removeClass("search-button-clear"),0<e.length?s.hide():s.show()}),$(".search-form").on("submit",function(t){t.preventDefault()}),o.on("click",function(){$(this).hasClass("search-button-clear")&&t.val("").focus().keyup()})}function l(t){t.posts.forEach(function(t){n.addDoc(t)}),localStorage.setItem("dawn_search_index",JSON.stringify(n)),localStorage.setItem("dawn_search_last",t.posts[0].updated_at)}}function burger(){"use strict";$(".burger").on("click",function(){body.toggleClass("menu-opened")})}function gravatar(){"use strict";var t=$(".account-image");t.length&&(t.attr("data-src","https://www.gravatar.com/avatar/"+md5(t.attr("data-email"))+"?d=mp&s=160"),lazySizes.loader.unveil(t[0]))}function plan(){"use strict";var t=$(".plan-selector-button");t.on("click",function(){t.addClass("button-secondary"),$(this).removeClass("button-secondary"),$(this).closest(".plan-selector").attr("class","plan-selector plan-selector-"+$(this).attr("data-plan"))})}function theme(){"use strict";var t=$(".js-theme"),e=t.find(".theme-text");function a(){html.removeClass(["theme-dark","theme-light"]),localStorage.removeItem("dawn_theme"),e.text(t.attr("data-system"))}function n(){html.removeClass("theme-light").addClass("theme-dark"),localStorage.setItem("dawn_theme","dark"),e.text(t.attr("data-dark"))}function o(){html.removeClass("theme-dark").addClass("theme-light"),localStorage.setItem("dawn_theme","light"),e.text(t.attr("data-light"))}switch(localStorage.getItem("dawn_theme")){case"dark":n();break;case"light":o();break;default:a()}t.on("click",function(t){t.preventDefault(),(html.hasClass("theme-dark")||html.hasClass("theme-light")?html.hasClass("theme-dark")?o:a:n)()})}function pswp(n,c,r,d,u){function o(t,e){var n,a,o,i,s,l=document.querySelectorAll(".pswp")[0];s=[],$(e).find(c).each(function(t,e){a=$(e),o=a.find(r),i={src:u?a.find("img").attr("src"):o.attr("href"),w:0,h:0},d&&a.find(d).length&&(i.title=a.find(d).html()),s.push(i)}),(n=new PhotoSwipe(l,PhotoSwipeUI_Default,s,{closeOnScroll:!1,history:!1,index:t,shareEl:!1,showAnimationDuration:0,showHideOpacity:!0})).listen("gettingData",function(t,e){if(e.w<1||e.h<1){var a=new Image;a.onload=function(){e.w=this.width,e.h=this.height,n.updateSize(!0)},a.src=e.src}}),n.init()}$(n).on("click",r,function(t){!function(t){t.preventDefault();var e=$(t.target).closest(n).find(c).index($(t.target).closest(c)),a=$(t.target).closest(n);o(e,a[0])}(t)})}function notification(){"use strict";var t=$(".notification");$(".notification-close").on("click",function(t){t.preventDefault(),body.addClass("notification-closing");var e=window.location.toString();if(0<e.indexOf("?")){var a=e.substring(0,e.indexOf("?"));window.history.replaceState({},document.title,a)}$(this).closest(".auth-form").length&&$(this).closest(".auth-form").removeClass("success error")}),t.on("transitionend",function(){body.hasClass("notification-closing")&&body.removeClass("notification-closing notification-opened")})}function getParameterByName(t,e){"use strict";e=e||window.location.href,t=t.replace(/[\[\]]/g,"\\$&");var a=new RegExp("[?&]"+t+"(=([^&#]*)|&|#|$)").exec(e);return a?a[2]?decodeURIComponent(a[2].replace(/\+/g," ")):"":null}$(function(){"use strict";subMenu(),whiteLogo(),whiteIcon(),featured(),pagination(),video(),gallery(),table(),toc(),modal(),search(),burger(),gravatar(),plan(),theme(),notification()}),$(window).on("scroll",function(){"use strict";body.hasClass("post-template")&&(timeout&&window.cancelAnimationFrame(timeout),timeout=window.requestAnimationFrame(sticky))}),$(window).on("load",function(){"use strict";if(body.hasClass("post-template")){titleOffset=$(".single-title").offset().top;var t=$(".single-content"),e=t.height();contentOffset=t.offset().top+e-$(window).height()/2}});